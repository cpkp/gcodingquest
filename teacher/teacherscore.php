...
// Query to fetch lessons for the logged-in user including course name and student name, ordered by lesson name
...
WHERE lessons.creator_id = '$user_id' 
