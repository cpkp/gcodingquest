...
$sql = "SELECT lessons.*, courses.name AS course_name FROM lessons INNER JOIN courses ON lessons.course_id = courses.id";
...
<head>
    ...
    <style>
        ...
        .lesson-card {
            /* Define your lesson card styles */
        }
        .lesson-card h3 {
             /* Define your heading styles */
        }
