...
<body>
    <div class="container">
        ...
        <form action="upload_lesson.php" method="post" enctype="multipart/form-data">
            ...
            <input type="file" id="lesson_folder" name="lesson_folder" accept=".zip" required><br><br>
            <label for="max_score">Maximum Score:</label><br> <!-- Add label for max score -->
            <input type="number" id="max_score" name="max_score" required><br><br> <!-- Add input for max score -->
