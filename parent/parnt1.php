...
<div class="container">
  <section id="greeting">
    ...
    if (isset($_SESSION['parent_username'])) {
        echo 'Welcome  Parent ' . $_SESSION['parent_username'] . '!';
    } else {
  ...
  <a href="parentscore.php" class="btn">SCORE</a>
  <a href="parentgenerate.php" class="btn">Pcode</a>
  <a href="viewall.php" class="btn">Experience</a>
  <a href="msgpar.php" class="btn">Message</a>
</div>
